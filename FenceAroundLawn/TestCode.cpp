...
int main()
{
	...
	unsigned int grassPrice = lawn->GetGrassPrice(eGrassType::PERENNIAL_RYEGRASS);
	unsigned int sodRollsCount = lawn->GetMinimumSodRollsCount();
	unsigned int fencePrice = rectangleLawn->GetFencePrice(eFenceType::SPRUCE);
	...
	area = lawn->GetArea();
	grassPrice = lawn->GetGrassPrice(eGrassType::ST_AUGUSTINE);
	sodRollsCount = lawn->GetMinimumSodRollsCount();
	fencePrice = equilateralTriangleLawn->GetFencePrice(eFenceType::RED_CEDAR);
	fencesCount = equilateralTriangleLawn->GetMinimumFencesCount();
	assert(area == 21);
	assert(grassPrice == 95);
	assert(sodRollsCount == 70);
	std::cout << sodRollsCount << std::endl;
	assert(fencePrice == 126);
	...
	area = lawn->GetArea();
	grassPrice = lawn->GetGrassPrice(eGrassType::BAHIA);
	sodRollsCount = lawn->GetMinimumSodRollsCount();
	fencePrice = equilateralTriangleLawn->GetFencePrice(eFenceType::RED_CEDAR);
	fencesCount = equilateralTriangleLawn->GetMinimumFencesCount();
	assert(area == 7);
	...
	area = lawn->GetArea();
	grassPrice = lawn->GetGrassPrice(eGrassType::BENTGRASS);
	sodRollsCount = lawn->GetMinimumSodRollsCount();
	fencePrice = squareLawn->GetFencePrice(eFenceType::SPRUCE);
	...
	area = lawn->GetArea();
	grassPrice = lawn->GetGrassPrice(eGrassType::PERENNIAL_RYEGRASS);
	sodRollsCount = lawn->GetMinimumSodRollsCount();
	assert(area == 13);
